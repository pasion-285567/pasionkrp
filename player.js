//player.js
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        playerContainers.forEach(container => {
            ...
            const timestampProgress = container.querySelector('.timestamp-progress');
            const timestampDuration = container.querySelector('.timestamp-duration');
            ...
            function updatePlayPauseIcons(isPlaying) {
                const mainPlayIcon = container.querySelector('.play-icon');
                const mainPauseIcon = container.querySelector('.pause-icon');
    ...
    window.initCustomPlayers = function() {
        const playerContainers = document.querySelectorAll('.player-container');
        playerContainers.forEach(container => {
            const videoPlayer = container.querySelector('video');
            const mainPlayButton = container.querySelector('.main-play-button');
